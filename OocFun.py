...
async def playerreacts(message):
    ...
    if ("nini " in (message.content).lower() or "goodnight" in (message.content).lower() or "good night" in (message.content).lower() or "night" in (message.content).lower() or "gn " in (message.content).lower()) and "ken" in message.content.lower() and str(message.channel).lower() == "ooc":
