...
mazearray = [[["NEW", "NW", "NSX", "NS", "N", "NE"], ["W", "ES", "NW", "NE", "EW", "EW"], ["EW", "NW", "ES", "SW", "ES", "EW"], ["ESW", "EW", "NW", "NS", "NE", "EW"], ["NW", "ES", "SW", "NE", "SW", "E"], ["SW", "NS", "NES", "ESWB", "NSW", "ES"]],
             [["NW", "NS", "NEX", "NW", "NE", "NEW"], ["SW", "NE", "SW", "ES", "SW", "E"], ["NW", "E", "NW", "NS", "N", "ES"], ["EW", "EW", "SW", "NES", "SW", "NE"], ["EW", "EW", "NW", "N", "NE", "EW"], ["ESW", "SW", "ES", "ESWB", "SW", "ES"]],
             [["NW", "NES", "NSWX", "NS", "NS", "NE"], ["SW", "N", "NE", "NW", "N", "ES"], ["NW", "E", "ESW", "EW", "SW", "NE"], ["ESW", "W", "N", "ES", "NW", "ES"], ["NW", "ES", "SW", "NES", "EW", "NEW"], ["SW", "NS", "NS", "NESB", "SW", "ES"]],
             [["NEW", "NW", "NX", "NS", "NS", "NE"], ["W", "ES", "EW", "NW", "NE", "EW"], ["W", "NES", "ESW", "EW", "SW", "ES"], ["SW", "N", "NS", "S", "N", "NES"], ["NW", "ES", "NW", "NES", "SW", "NE"], ["SW", "NS", "ES", "NSWB", "NS", "ES"]],
             ...
             [["NW", "NS", "NE", "NSWX", "N", "NE", "NEW"], ["SW", "NE", "SW", "N", "E", "SW", "ES"], ["NW", "ES", "NW", "ES", "SW", "NS", "NE"], ["SW", "NE", "W", "NS", "NS", "NE", "EW"], ["NW", "ES", "SW", "NE", "NSW", "ES", "EW"], ["EW", "NW", "NS", "ES", "NSW", "NE", "EW"], ["SW", "S", "NS", "NSB", "NES", "SW", "ES"]],
             [["NW", "NS", "N", "NESX", "NEW", "NW", "NE"], ["EW", "NEW", "W", "NS", "S", "ES", "EW"], ["EW", "W", "S", "NS", "NES", "NW", "E"], ["ESW", "SW", "NE", "NW", "N", "E", "ESW"], ["NW", "NE", "W", "E", "ESW", "W", "NE"], ["EW", "SW", "E", "SW", "NS", "ES", "EW"], ["SW", "NS", "S", "NSB", "NS", "NS", "ES"]],
             [["NW", "NE", "NSWX", "NS", "NE"], ["EW", "EW", "NW", "NE", "EW"], ["W", "S", "ES", "W", "ES"], ["EW", "NW", "NS", "S", "NE"], ["SW", "S", "NESB", "NSW", "ES"]],
             [["NEW", "NW", "NEX", "NW", "NES"], ["W", "ES", "ESW", "W", "NE"], ["W", "NS", "N", "E", "ESW"], ["EW", "NW", "ES", "W", "NE"], ["SW", "ES", "NSWB", "ES", "ESW"]],
