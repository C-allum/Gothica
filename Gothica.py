...
async def on_message(message):
    ...
    try:
        # Check if Gothy is in the correct server, if not, clean up and end function
        ...
        if not "verification" in str(message.channel).lower():
            ...
            if not isbot:
                ...
                #New member
                    ...
                    player_list.append(str(message.author.name + '#' + message.author.discriminator))
