                    ...
                    try:
                        ...
                        if str(message.author) in str(economydata[b][0]):
                            ...
                            if int(workdiff) > 84600:
                                ...
                                await message.delete()
                                TransactionsDatabaseInterface.addTransaction(message.author.name + "#" + str(message.author.discriminator), TransactionsDatabaseInterface.DezzieMovingAction.Work, int(int(newtot - economydata[b][1])))
